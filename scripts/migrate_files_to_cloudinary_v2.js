// scripts/migrate_files_to_cloudinary_v2.js
...
async function migrateFiles() {
    try {
        ...
        console.log(`📁 Actual files in directory: ${actualFiles.length}`);
        ...
        for (const member of memberships) {
            ...
            if (member.documentsUrl && member.documentsUrl.startsWith('/uploads/')) {
                ...
                if (fs.existsSync(localPath)) {
                    ...
                    console.log(`   ⚠️ Documents file not found. Setting to null.`);
            ...
            if (member.pdfUrl && member.pdfUrl.startsWith('/pdfs/')) {
                ...
                if (fs.existsSync(localPath)) {
                    ...
                    console.log(`   ⚠️ PDF file not found. Setting to null.`);
                    member.pdfUrl = null;
                    memberUpdated = true;
                    skippedCount++;
                }
